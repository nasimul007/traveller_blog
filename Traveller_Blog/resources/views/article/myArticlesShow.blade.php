                    ...
                    <div class="single-listing-content">
                        <div class="contact-form">
                            ...
                            @if($art->verification=='yes')
                                <h4>Verified</h4>
                            @endif
                            @if($art->verification=='no')
                                <h4>Pending</h4>
                            @endif
                            @if($art->verification=='blocked')
                                <h4>Blocked by moderator</h4>
                            @endif  
                            @if($art->verification=='reported')
                                <h4>Reported by user</h4>
                            @endif                                                                          
                            <p>{{$art->article}}</p>
                            ...
                            @endforeach
                            <br>
                            <a href="{{route('article.show', [$art->article_id])}}">Show Full Story</a><br>
