...
<head>
    ...
    <title>Report this comment</title>
</head>
<body>
    <!-- Preloader -->
    <div id="preloader">
                ...
                <div class="col-12 col-lg-12">
                    <div class="single-listing-content">
                        <div class="contact-form">
                            <form method='post'>
                                @csrf
                                <p>Commenter : {{$comments->name}}</p>
                                <p>Comment : {{$comments->comment}}</p>
                                <input type='hidden' name='commenter_id' value='{{$comments->commenter_id}}'>
                                <textarea name='report' placeholder='Report text here' rows="4" style='width:100%' class="form-control"></textarea><br>
                                <input type='submit' name='report_button' class="btn dorne-btn" value='Report'>
                            </form>
                        </div>
                    </div>
                </div>
