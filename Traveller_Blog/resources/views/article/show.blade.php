                    ...
                    <div class="col-12 col-lg-12">
                        <div class="single-listing-content">
                            <div class="contact-form">
                                <form method='post'>
                                    @csrf
                                    <textarea rows='3' style='width:100%' name='comment_area' class="form-control" placeholder='comment for this post'></textarea><br>
                        ...
                        <div class="single-listing-content">
                            <div class="contact-form">
                                <div>
                                    ...
                                    {{$com->comment}}
                                    @if(session()->has('user_id'))
                                        <br><a href="{{route('article.commentreport', [$com->comment_id])}}">Report this comment </a>
                                    @endif
                                </div>
                            </div>
                        </div>
