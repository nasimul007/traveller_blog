...
<!--===============================================================================================-->  
    ...
    <title>User List For Super Admin</title>
</head>
<body>
     <!-- Preloader -->
     <div id="preloader">
    ...
    <!-- ***** Breadcumb Area End ***** -->
        <h2>User List For Moderator And Block</h2>
    ...
    <table>
        <tr>
            ...
            @if($user->status=='live')
                <td></td>
                <td> <input type="checkbox" name="statusblock[]" value={{$user->user_id}}>Block User</td>
                <td></td>
                @if($user->moderator_level==0)
                <td></td>
                <td> <input type="checkbox" name="statusmod1[]" value={{$user->user_id}}>Make Level 1 Moderator</td>
                <td></td>
                @endif
                @if($user->moderator_level==1)
                <td></td>
                <td> <input type="checkbox" name="statusmod2[]" value={{$user->user_id}}>Make Level 2 Moderator</td>
                <td></td>
                @endif
            @endif
        </tr>
