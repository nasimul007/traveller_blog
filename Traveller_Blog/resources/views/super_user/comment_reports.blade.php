            ...
            <div class="wrap-table100">
                    <div class="table">
                        ...
                        <div class="row">
                            ...
                            <div class="cell" data-title="Delete Comment">
                                <form method="post">
                                     @csrf
                                        <input type="checkbox" name="statusyes[]" value={{$post_report->comment_id }} >Delete Comment
                            </div>

                            <div class="cell" data-title=" Wrong Report">
                                 <input type="checkbox" name="statusno[]" value={{$post_report->comment_id}} >wrong report   
                            </div>
