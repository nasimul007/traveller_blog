                                    ...
                                    @if(session('type')=='admin')
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="navbarDropdown2">                                            
                                                ...
                                                <a class="dropdown-item" href="{{route('super_user.low_accuracy')}}">Low Acccuracy Posts</a>
                                                <a class="dropdown-item" href="{{route('super_user.comment_report')}}">Comment Reports</a>
                                                <a class="dropdown-item" href="{{route('super_user.user_list')}}">User List</a>
                                            </div>
                                        </li>    
                                    @endif
                                @endif
                        ...
                        <div class="row">
                            ...
                            <div class="cell" data-title="Article">
                                ...
                                @foreach($article_images as $img)
                                    @if($img->article_id==$article->article_id)
