                    ...
                    <div class="col-12 col-lg-12">
                        <div class="single-listing-content">
                            <div class="contact-form">
                                    <h2>{{$ntc->notice_title}}</h2>
                                    <h4>Posted at : {{$ntc->created_at}}</h4>

                                    @if(strlen($ntc->notice)>=5000)
                                        <p>{{substr($ntc->notice, 0, 5000)}}</p>
                                        <a href="{{route('noitce.show', [$ntc->notice_id])}}">Show more </a>
                                    @else
                                        <p>{{$ntc->notice}}</p>
                                    @endif
                                </div>
